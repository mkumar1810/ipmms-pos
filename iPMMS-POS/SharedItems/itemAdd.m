...
- (BOOL) validateData
{
    ...
    if ([txtItemPrice.text intValue]==0) 
    {
...
{
    if([textField isEqual:txtItemName])
...
{
    NSMutableDictionary *returnDict = [[NSMutableDictionary alloc] initWithObjectsAndKeys:txtItemName.text, @"p_itemname", txtItemPrice.text , @"p_itemprice" , nil];
    return returnDict;
}
